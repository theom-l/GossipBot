...
class DescribeTags(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(DescribeTags, self).__init__(temboo_session, '/Library/Amazon/MachineLearning/DescribeTags')
...
class DescribeTagsInputSet(InputSet):
    ...
    def set_ResourceId(self, value):
        ...
        """
        super(DescribeTagsInputSet, self)._set_input('ResourceId', value)
    def set_ResourceType(self, value):
        ...
        """
        super(DescribeTagsInputSet, self)._set_input('ResourceType', value)
