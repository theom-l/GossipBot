...
class UpdateBatchPrediction(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(UpdateBatchPrediction, self).__init__(temboo_session, '/Library/Amazon/MachineLearning/UpdateBatchPrediction')


    def new_input_set(self):
        return UpdateBatchPredictionInputSet()

    def _make_result_set(self, result, path):
        return UpdateBatchPredictionResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return UpdateBatchPredictionChoreographyExecution(session, exec_id, path)

class UpdateBatchPredictionInputSet(InputSet):
    """
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(UpdateBatchPredictionInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(UpdateBatchPredictionInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_BatchPredictionId(self, value):
        ...
        """
        super(UpdateBatchPredictionInputSet, self)._set_input('BatchPredictionId', value)
    def set_BatchPredictionName(self, value):
        ...
        """
        super(UpdateBatchPredictionInputSet, self)._set_input('BatchPredictionName', value)
    def set_UserRegion(self, value):
        ...
        """
        super(UpdateBatchPredictionInputSet, self)._set_input('UserRegion', value)

class UpdateBatchPredictionResultSet(ResultSet):
    """
...
class UpdateBatchPredictionChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return UpdateBatchPredictionResultSet(response, path)
