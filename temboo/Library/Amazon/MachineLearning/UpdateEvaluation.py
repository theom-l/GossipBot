...
class UpdateEvaluation(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(UpdateEvaluation, self).__init__(temboo_session, '/Library/Amazon/MachineLearning/UpdateEvaluation')


    def new_input_set(self):
        return UpdateEvaluationInputSet()

    def _make_result_set(self, result, path):
        return UpdateEvaluationResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return UpdateEvaluationChoreographyExecution(session, exec_id, path)

class UpdateEvaluationInputSet(InputSet):
    """
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(UpdateEvaluationInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(UpdateEvaluationInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_EvaluationId(self, value):
        ...
        """
        super(UpdateEvaluationInputSet, self)._set_input('EvaluationId', value)
    def set_EvaluationName(self, value):
        ...
        """
        super(UpdateEvaluationInputSet, self)._set_input('EvaluationName', value)
    def set_UserRegion(self, value):
        ...
        """
        super(UpdateEvaluationInputSet, self)._set_input('UserRegion', value)

class UpdateEvaluationResultSet(ResultSet):
    """
...
class UpdateEvaluationChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return UpdateEvaluationResultSet(response, path)
