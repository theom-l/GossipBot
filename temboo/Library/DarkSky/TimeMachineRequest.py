...
class TimeMachineRequest(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(TimeMachineRequest, self).__init__(temboo_session, '/Library/DarkSky/TimeMachineRequest')
    ...
    def _make_result_set(self, result, path):
        return TimeMachineRequestResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return TimeMachineRequestChoreographyExecution(session, exec_id, path)

class TimeMachineRequestInputSet(InputSet):
    """
    ...
    def set_APIKey(self, value):
        ...
        """
        super(TimeMachineRequestInputSet, self)._set_input('APIKey', value)
    def set_Exclude(self, value):
        ...
        """
        super(TimeMachineRequestInputSet, self)._set_input('Exclude', value)
    def set_Extend(self, value):
        ...
        """
        super(TimeMachineRequestInputSet, self)._set_input('Extend', value)
    ...
    def set_Time(self, value):
        ...
        """
        super(TimeMachineRequestInputSet, self)._set_input('Time', value)
    def set_Units(self, value):
        ...
        """
        super(TimeMachineRequestInputSet, self)._set_input('Units', value)

class TimeMachineRequestResultSet(ResultSet):
    """
...
class TimeMachineRequestChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return TimeMachineRequestResultSet(response, path)
