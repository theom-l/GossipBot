...
class CopyReferenceGet(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CopyReferenceGet, self).__init__(temboo_session, '/Library/Dropbox/Files/CopyReferenceGet')


    def new_input_set(self):
        return CopyReferenceGetInputSet()

    def _make_result_set(self, result, path):
        return CopyReferenceGetResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return CopyReferenceGetChoreographyExecution(session, exec_id, path)

class CopyReferenceGetInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(CopyReferenceGetInputSet, self)._set_input('AccessToken', value)
    def set_Path(self, value):
        ...
        """
        super(CopyReferenceGetInputSet, self)._set_input('Path', value)

class CopyReferenceGetResultSet(ResultSet):
    """
...
class CopyReferenceGetChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return CopyReferenceGetResultSet(response, path)
