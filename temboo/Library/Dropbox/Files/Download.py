...
class Download(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(Download, self).__init__(temboo_session, '/Library/Dropbox/Files/Download')
...
class DownloadInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(DownloadInputSet, self)._set_input('AccessToken', value)
    def set_Encode(self, value):
        ...
        """
        super(DownloadInputSet, self)._set_input('Encode', value)
    def set_Path(self, value):
        """
        Set the value of the Path input for this Choreo. ((required, string) The path of the file to download.)
        """
        super(DownloadInputSet, self)._set_input('Path', value)
