...
class GetLatestCursor(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetLatestCursor, self).__init__(temboo_session, '/Library/Dropbox/Files/GetLatestCursor')
    ...
    def _make_result_set(self, result, path):
        return GetLatestCursorResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetLatestCursorChoreographyExecution(session, exec_id, path)

class GetLatestCursorInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetLatestCursorInputSet, self)._set_input('AccessToken', value)
    def set_IncludeDeleted(self, value):
        ...
        """
        super(GetLatestCursorInputSet, self)._set_input('IncludeDeleted', value)
    def set_IncludeHasExplicitSharedMembers(self, value):
        ...
        """
        super(GetLatestCursorInputSet, self)._set_input('IncludeHasExplicitSharedMembers', value)
    def set_IncludeMediaInfo(self, value):
        ...
        """
        super(GetLatestCursorInputSet, self)._set_input('IncludeMediaInfo', value)
    def set_Path(self, value):
        ...
        """
        super(GetLatestCursorInputSet, self)._set_input('Path', value)
    def set_Recursive(self, value):
        ...
        """
        super(GetLatestCursorInputSet, self)._set_input('Recursive', value)

class GetLatestCursorResultSet(ResultSet):
    """
...
class GetLatestCursorChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetLatestCursorResultSet(response, path)
