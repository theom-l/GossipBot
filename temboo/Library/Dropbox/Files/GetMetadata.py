...
class GetMetadata(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetMetadata, self).__init__(temboo_session, '/Library/Dropbox/Files/GetMetadata')
    ...
    def _make_result_set(self, result, path):
        return GetMetadataResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetMetadataChoreographyExecution(session, exec_id, path)

class GetMetadataInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetMetadataInputSet, self)._set_input('AccessToken', value)
    def set_IncludeDeleted(self, value):
        ...
        """
        super(GetMetadataInputSet, self)._set_input('IncludeDeleted', value)
    def set_IncludeHasExplicitSharedMembers(self, value):
        ...
        """
        super(GetMetadataInputSet, self)._set_input('IncludeHasExplicitSharedMembers', value)
    def set_IncludeMediaInfo(self, value):
        ...
        """
        super(GetMetadataInputSet, self)._set_input('IncludeMediaInfo', value)
    def set_Path(self, value):
        """
        Set the value of the Path input for this Choreo. ((required, string) The path of a file or folder on Dropbox.)
        """
        super(GetMetadataInputSet, self)._set_input('Path', value)

class GetMetadataResultSet(ResultSet):
    """
...
class GetMetadataChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetMetadataResultSet(response, path)
