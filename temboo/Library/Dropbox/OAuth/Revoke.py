...
class Revoke(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(Revoke, self).__init__(temboo_session, '/Library/Dropbox/OAuth/Revoke')


    def new_input_set(self):
        return RevokeInputSet()

    def _make_result_set(self, result, path):
        return RevokeResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return RevokeChoreographyExecution(session, exec_id, path)

class RevokeInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(RevokeInputSet, self)._set_input('AccessToken', value)

class RevokeResultSet(ResultSet):
    """
...
class RevokeChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return RevokeResultSet(response, path)
