...
class RevokeSharedLink(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RevokeSharedLink, self).__init__(temboo_session, '/Library/Dropbox/Sharing/RevokeSharedLink')


    def new_input_set(self):
        return RevokeSharedLinkInputSet()

    def _make_result_set(self, result, path):
        return RevokeSharedLinkResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return RevokeSharedLinkChoreographyExecution(session, exec_id, path)

class RevokeSharedLinkInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(RevokeSharedLinkInputSet, self)._set_input('AccessToken', value)
    def set_URL(self, value):
        """
        Set the value of the URL input for this Choreo. ((required, string) The URL of the shared link.)
        """
        super(RevokeSharedLinkInputSet, self)._set_input('URL', value)

class RevokeSharedLinkResultSet(ResultSet):
    """
...
class RevokeSharedLinkChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return RevokeSharedLinkResultSet(response, path)
