...
class AddFavoriteActivity(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AddFavoriteActivity, self).__init__(temboo_session, '/Library/Fitbit/Activities/AddFavoriteActivity')
...
class AddFavoriteActivityInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(AddFavoriteActivityInputSet, self)._set_input('AccessToken', value)
    def set_AccessTokenSecret(self, value):
        """
        Set the value of the AccessTokenSecret input for this Choreo. ((required, string) The Access Token Secret retrieved during the OAuth process.)
        """
        super(AddFavoriteActivityInputSet, self)._set_input('AccessTokenSecret', value)
    def set_ActivityID(self, value):
        ...
        """
        super(AddFavoriteActivityInputSet, self)._set_input('ActivityID', value)
    def set_ConsumerKey(self, value):
        """
        Set the value of the ConsumerKey input for this Choreo. ((required, string) The Consumer Key provided by Fitbit.)
        """
        super(AddFavoriteActivityInputSet, self)._set_input('ConsumerKey', value)
    def set_ConsumerSecret(self, value):
        """
        Set the value of the ConsumerSecret input for this Choreo. ((required, string) The Consumer Secret provided by Fitbit.)
        """
        super(AddFavoriteActivityInputSet, self)._set_input('ConsumerSecret', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that you want the response to be in: xml or json. Defaults to json.)
        """
        super(AddFavoriteActivityInputSet, self)._set_input('ResponseFormat', value)
    def set_UserID(self, value):
        """
        Set the value of the UserID input for this Choreo. ((optional, string) The user's encoded id. Defaults to "-" (dash) which will return data for the user associated with the token credentials provided.)
        """
        super(AddFavoriteActivityInputSet, self)._set_input('UserID', value)
