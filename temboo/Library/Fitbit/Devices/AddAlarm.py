...
class AddAlarm(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AddAlarm, self).__init__(temboo_session, '/Library/Fitbit/Devices/AddAlarm')


    def new_input_set(self):
        return AddAlarmInputSet()

    def _make_result_set(self, result, path):
        return AddAlarmResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return AddAlarmChoreographyExecution(session, exec_id, path)

class AddAlarmInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(AddAlarmInputSet, self)._set_input('AccessToken', value)
    def set_AccessTokenSecret(self, value):
        """
        Set the value of the AccessTokenSecret input for this Choreo. ((required, string) The Access Token Secret retrieved during the OAuth process.)
        """
        super(AddAlarmInputSet, self)._set_input('AccessTokenSecret', value)
    def set_ConsumerKey(self, value):
        """
        Set the value of the ConsumerKey input for this Choreo. ((required, string) The Consumer Key provided by Fitbit.)
        """
        super(AddAlarmInputSet, self)._set_input('ConsumerKey', value)
    def set_ConsumerSecret(self, value):
        """
        Set the value of the ConsumerSecret input for this Choreo. ((required, string) The Consumer Secret provided by Fitbit.)
        """
        super(AddAlarmInputSet, self)._set_input('ConsumerSecret', value)
    def set_DeviceID(self, value):
        ...
        """
        super(AddAlarmInputSet, self)._set_input('DeviceID', value)
    def set_Enabled(self, value):
        ...
        """
        super(AddAlarmInputSet, self)._set_input('Enabled', value)
    def set_Label(self, value):
        """
        Set the value of the Label input for this Choreo. ((optional, string) A label for the alarm.)
        """
        super(AddAlarmInputSet, self)._set_input('Label', value)
    def set_Recurring(self, value):
        ...
        """
        super(AddAlarmInputSet, self)._set_input('Recurring', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that you want the response to be in: xml or json. Defaults to json.)
        """
        super(AddAlarmInputSet, self)._set_input('ResponseFormat', value)
    def set_SnoozeCount(self, value):
        ...
        """
        super(AddAlarmInputSet, self)._set_input('SnoozeCount', value)
    def set_SnoozeLength(self, value):
        ...
        """
        super(AddAlarmInputSet, self)._set_input('SnoozeLength', value)
    def set_Time(self, value):
        ...
        """
        super(AddAlarmInputSet, self)._set_input('Time', value)
    def set_UserID(self, value):
        """
        Set the value of the UserID input for this Choreo. ((optional, string) The user's encoded id. Defaults to "-" (dash) which will return data for the user associated with the token credentials provided.)
        """
        super(AddAlarmInputSet, self)._set_input('UserID', value)
    def set_Vibe(self, value):
        ...
        """
        super(AddAlarmInputSet, self)._set_input('Vibe', value)
    def set_WeekDays(self, value):
        ...
        """
        super(AddAlarmInputSet, self)._set_input('WeekDays', value)

class AddAlarmResultSet(ResultSet):
    """
...
class AddAlarmChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return AddAlarmResultSet(response, path)
