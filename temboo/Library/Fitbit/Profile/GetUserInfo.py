...
class GetUserInfo(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetUserInfo, self).__init__(temboo_session, '/Library/Fitbit/Profile/GetUserInfo')
...
class GetUserInfoInputSet(InputSet):
    ...
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(GetUserInfoInputSet, self)._set_input('AccessTokenSecret', value)
    def set_ConsumerKey(self, value):
        """
        Set the value of the ConsumerKey input for this Choreo. ((required, string) The Consumer Key provided by Fitbit.)
        """
        super(GetUserInfoInputSet, self)._set_input('ConsumerKey', value)
    def set_ConsumerSecret(self, value):
        """
        Set the value of the ConsumerSecret input for this Choreo. ((required, string) The Consumer Secret provided by Fitbit.)
        """
        super(GetUserInfoInputSet, self)._set_input('ConsumerSecret', value)
    ...
    def set_UserID(self, value):
        ...
        """
        super(GetUserInfoInputSet, self)._set_input('UserID', value)
