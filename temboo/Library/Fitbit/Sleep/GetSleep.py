...
class GetSleepResultSet(ResultSet):
    ...
    def get_TotalMinutesAsleep(self):
        """
        Retrieve the value for the "TotalMinutesAsleep" output from this Choreo execution. ((decimal) The total number of minutes asleep.)
        """
        return self._output.get('TotalMinutesAsleep', None)
    def get_TotalSleepRecords(self):
        """
        Retrieve the value for the "TotalSleepRecords" output from this Choreo execution. ((integer) The total number of sleep records.)
        """
        return self._output.get('TotalSleepRecords', None)
    def get_TotalTimeInBed(self):
        """
        Retrieve the value for the "TotalTimeInBed" output from this Choreo execution. ((decimal) The summarized total for time in bed.)
        """
        return self._output.get('TotalTimeInBed', None)
