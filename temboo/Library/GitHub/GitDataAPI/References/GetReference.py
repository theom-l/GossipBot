...
class GetReference(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetReference, self).__init__(temboo_session, '/Library/GitHub/GitDataAPI/References/GetReference')
...
class GetReferenceInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetReferenceInputSet, self)._set_input('AccessToken', value)
    def set_Ref(self, value):
        ...
        """
        super(GetReferenceInputSet, self)._set_input('Ref', value)
    def set_Repo(self, value):
        ...
        """
        super(GetReferenceInputSet, self)._set_input('Repo', value)
    def set_User(self, value):
        """
        Set the value of the User input for this Choreo. ((required, string) The GitHub username.)
        """
        super(GetReferenceInputSet, self)._set_input('User', value)
