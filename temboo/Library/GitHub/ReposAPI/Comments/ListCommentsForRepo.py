...
class ListCommentsForRepo(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListCommentsForRepo, self).__init__(temboo_session, '/Library/GitHub/ReposAPI/Comments/ListCommentsForRepo')
...
class ListCommentsForRepoInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(ListCommentsForRepoInputSet, self)._set_input('AccessToken', value)
