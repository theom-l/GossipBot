...
class GetReadMe(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetReadMe, self).__init__(temboo_session, '/Library/GitHub/ReposAPI/Contents/GetReadMe')
...
class GetReadMeInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetReadMeInputSet, self)._set_input('AccessToken', value)
