...
class GetRepo(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetRepo, self).__init__(temboo_session, '/Library/GitHub/ReposAPI/Repos/GetRepo')
