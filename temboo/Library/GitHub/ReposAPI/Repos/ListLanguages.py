...
class ListLanguages(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListLanguages, self).__init__(temboo_session, '/Library/GitHub/ReposAPI/Repos/ListLanguages')
