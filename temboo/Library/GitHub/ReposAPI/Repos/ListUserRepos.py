...
class ListUserRepos(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListUserRepos, self).__init__(temboo_session, '/Library/GitHub/ReposAPI/Repos/ListUserRepos')
...
class ListUserReposInputSet(InputSet):
    ...
    def set_Direction(self, value):
        ...
        """
        super(ListUserReposInputSet, self)._set_input('Direction', value)
    ...
    def set_Sort(self, value):
        ...
        """
        super(ListUserReposInputSet, self)._set_input('Sort', value)
    def set_Type(self, value):
        ...
        """
        super(ListUserReposInputSet, self)._set_input('Type', value)
    def set_User(self, value):
        """
        Set the value of the User input for this Choreo. ((required, string) The GitHub username.)
        """
        super(ListUserReposInputSet, self)._set_input('User', value)
