...
class AnalyzeSentiment(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AnalyzeSentiment, self).__init__(temboo_session, '/Library/Google/NaturalLanguage/Documents/AnalyzeSentiment')


    def new_input_set(self):
        return AnalyzeSentimentInputSet()

    def _make_result_set(self, result, path):
        return AnalyzeSentimentResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return AnalyzeSentimentChoreographyExecution(session, exec_id, path)

class AnalyzeSentimentInputSet(InputSet):
    """
    ...
    def set_APIKey(self, value):
        ...
        """
        super(AnalyzeSentimentInputSet, self)._set_input('APIKey', value)
    def set_Content(self, value):
        """
        Set the value of the Content input for this Choreo. ((conditional, string) The content to analyze.)
        """
        super(AnalyzeSentimentInputSet, self)._set_input('Content', value)
    def set_EncodingType(self, value):
        ...
        """
        super(AnalyzeSentimentInputSet, self)._set_input('EncodingType', value)
    def set_Fields(self, value):
        ...
        """
        super(AnalyzeSentimentInputSet, self)._set_input('Fields', value)
    def set_GCSContentUri(self, value):
        ...
        """
        super(AnalyzeSentimentInputSet, self)._set_input('GCSContentUri', value)
    def set_Language(self, value):
        ...
        """
        super(AnalyzeSentimentInputSet, self)._set_input('Language', value)
    def set_Type(self, value):
        ...
        """
        super(AnalyzeSentimentInputSet, self)._set_input('Type', value)

class AnalyzeSentimentResultSet(ResultSet):
    """
    ...
    def get_Score(self):
        ...
        """
        return self._output.get('Score', None)
...
class AnalyzeSentimentChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return AnalyzeSentimentResultSet(response, path)
