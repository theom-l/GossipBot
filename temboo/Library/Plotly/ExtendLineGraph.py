...
class ExtendLineGraph(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ExtendLineGraph, self).__init__(temboo_session, '/Library/Plotly/ExtendLineGraph')


    def new_input_set(self):
        return ExtendLineGraphInputSet()

    def _make_result_set(self, result, path):
        return ExtendLineGraphResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ExtendLineGraphChoreographyExecution(session, exec_id, path)

class ExtendLineGraphInputSet(InputSet):
    """
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ExtendLineGraphInputSet, self)._set_input('APIKey', value)
    ...
    def set_WorldReadable(self, value):
        ...
        """
        super(ExtendLineGraphInputSet, self)._set_input('WorldReadable', value)
    def set_XValue(self, value):
        ...
        """
        super(ExtendLineGraphInputSet, self)._set_input('XValue', value)
    def set_YValue(self, value):
        ...
        """
        super(ExtendLineGraphInputSet, self)._set_input('YValue', value)

class ExtendLineGraphResultSet(ResultSet):
    """
...
class ExtendLineGraphChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return ExtendLineGraphResultSet(response, path)
