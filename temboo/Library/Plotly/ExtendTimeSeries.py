...
class ExtendTimeSeries(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ExtendTimeSeries, self).__init__(temboo_session, '/Library/Plotly/ExtendTimeSeries')


    def new_input_set(self):
        return ExtendTimeSeriesInputSet()

    def _make_result_set(self, result, path):
        return ExtendTimeSeriesResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ExtendTimeSeriesChoreographyExecution(session, exec_id, path)

class ExtendTimeSeriesInputSet(InputSet):
    """
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ExtendTimeSeriesInputSet, self)._set_input('APIKey', value)
    def set_FileName(self, value):
        ...
        """
        super(ExtendTimeSeriesInputSet, self)._set_input('FileName', value)
    ...
    def set_WorldReadable(self, value):
        ...
        """
        super(ExtendTimeSeriesInputSet, self)._set_input('WorldReadable', value)
    def set_XValue(self, value):
        ...
        """
        super(ExtendTimeSeriesInputSet, self)._set_input('XValue', value)
    def set_YValue(self, value):
        ...
        """
        super(ExtendTimeSeriesInputSet, self)._set_input('YValue', value)

class ExtendTimeSeriesResultSet(ResultSet):
    """
...
class ExtendTimeSeriesChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return ExtendTimeSeriesResultSet(response, path)
