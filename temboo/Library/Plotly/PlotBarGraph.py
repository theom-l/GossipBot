...
class PlotBarGraph(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(PlotBarGraph, self).__init__(temboo_session, '/Library/Plotly/PlotBarGraph')
    ...
    def _make_result_set(self, result, path):
        return PlotBarGraphResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return PlotBarGraphChoreographyExecution(session, exec_id, path)

class PlotBarGraphInputSet(InputSet):
    """
    ...
    def set_APIKey(self, value):
        ...
        """
        super(PlotBarGraphInputSet, self)._set_input('APIKey', value)
    def set_FileName(self, value):
        ...
        """
        super(PlotBarGraphInputSet, self)._set_input('FileName', value)
    ...
    def set_WorldReadable(self, value):
        ...
        """
        super(PlotBarGraphInputSet, self)._set_input('WorldReadable', value)
    def set_XValues(self, value):
        ...
        """
        super(PlotBarGraphInputSet, self)._set_input('XValues', value)
    def set_YValues(self, value):
        ...
        """
        super(PlotBarGraphInputSet, self)._set_input('YValues', value)

class PlotBarGraphResultSet(ResultSet):
    """
...
class PlotBarGraphChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return PlotBarGraphResultSet(response, path)
