...
class GetFriendsByID(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetFriendsByID, self).__init__(temboo_session, '/Library/Twitter/FriendsAndFollowers/GetFriendsByID')
...
class GetFriendsByIDInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetFriendsByIDInputSet, self)._set_input('AccessToken', value)
    def set_AccessTokenSecret(self, value):
        """
        Set the value of the AccessTokenSecret input for this Choreo. ((required, string) The Access Token Secret provided by Twitter or retrieved during the OAuth process.)
        """
        super(GetFriendsByIDInputSet, self)._set_input('AccessTokenSecret', value)
    def set_ConsumerKey(self, value):
        ...
        """
        super(GetFriendsByIDInputSet, self)._set_input('ConsumerKey', value)
    def set_ConsumerSecret(self, value):
        ...
        """
        super(GetFriendsByIDInputSet, self)._set_input('ConsumerSecret', value)
    def set_Cursor(self, value):
        ...
        """
        super(GetFriendsByIDInputSet, self)._set_input('Cursor', value)
    def set_ScreenName(self, value):
        ...
        """
        super(GetFriendsByIDInputSet, self)._set_input('ScreenName', value)
    def set_StringifyIDs(self, value):
        ...
        """
        super(GetFriendsByIDInputSet, self)._set_input('StringifyIDs', value)
    def set_UserID(self, value):
        ...
        """
        super(GetFriendsByIDInputSet, self)._set_input('UserID', value)
