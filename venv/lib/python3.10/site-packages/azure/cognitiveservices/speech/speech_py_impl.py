   ...
   *Values:*
   ...
   .. py:attribute:: SpeechServiceConnection_VoicesListEndpoint
    ...
    .. py:attribute:: PronunciationAssessment_ReferenceText
      ...
      .. note::
        This property id was added in version 1.14.0.
    ...
    .. py:attribute:: PronunciationAssessment_PhonemeAlphabet

      The phoneme alphabet to use for pronunciation evaluation. The valid values are "SAPI" (default) and "IPA"
      Under normal circumstances, you shouldn't have to use this property directly.

      .. note::
        This property id was added in version 1.20.0.

    .. py:attribute:: PronunciationAssessment_NBestPhonemeCount

      The number of N-best phonemes to return.
      Under normal circumstances, you shouldn't have to use this property directly.
...
DocstringForSpeechSynthesisOutputFormat = """
   ...
   *Values:*
   ...
   .. py:attribute:: Audio16Khz16Bit32KbpsMonoOpus
   ...
   .. py:attribute:: Audio24Khz16Bit48KbpsMonoOpus
   ...
   .. py:attribute:: Audio24Khz16Bit24KbpsMonoOpus
...
PropertyId_PronunciationAssessment_PhonemeAlphabet = _speech_py_impl.PropertyId_PronunciationAssessment_PhonemeAlphabet
PropertyId_PronunciationAssessment_NBestPhonemeCount = _speech_py_impl.PropertyId_PronunciationAssessment_NBestPhonemeCount
...
SpeechSynthesisOutputFormat_Audio16Khz16Bit32KbpsMonoOpus = _speech_py_impl.SpeechSynthesisOutputFormat_Audio16Khz16Bit32KbpsMonoOpus
SpeechSynthesisOutputFormat_Audio24Khz16Bit48KbpsMonoOpus = _speech_py_impl.SpeechSynthesisOutputFormat_Audio24Khz16Bit48KbpsMonoOpus
SpeechSynthesisOutputFormat_Audio24Khz16Bit24KbpsMonoOpus = _speech_py_impl.SpeechSynthesisOutputFormat_Audio24Khz16Bit24KbpsMonoOpus
...
class BotFrameworkConfig(DialogServiceConfig):
    ...
    __repr__ = _swig_repr
    if _newclass:
        _from_subscription = staticmethod(_speech_py_impl.BotFrameworkConfig__from_subscription)
    else:
        _from_subscription = _speech_py_impl.BotFrameworkConfig__from_subscription
    if _newclass:
        _from_authorization_token = staticmethod(_speech_py_impl.BotFrameworkConfig__from_authorization_token)
    else:
        _from_authorization_token = _speech_py_impl.BotFrameworkConfig__from_authorization_token
...
def BotFrameworkConfig__from_subscription(*args)  :
    return _speech_py_impl.BotFrameworkConfig__from_subscription(*args)
BotFrameworkConfig__from_subscription = _speech_py_impl.BotFrameworkConfig__from_subscription

def BotFrameworkConfig__from_authorization_token(*args)  :
    return _speech_py_impl.BotFrameworkConfig__from_authorization_token(*args)
BotFrameworkConfig__from_authorization_token = _speech_py_impl.BotFrameworkConfig__from_authorization_token
...
class CustomCommandsConfig(DialogServiceConfig):
    ...
    __repr__ = _swig_repr
    if _newclass:
        _from_subscription = staticmethod(_speech_py_impl.CustomCommandsConfig__from_subscription)
    else:
        _from_subscription = _speech_py_impl.CustomCommandsConfig__from_subscription
    if _newclass:
        _from_authorization_token = staticmethod(_speech_py_impl.CustomCommandsConfig__from_authorization_token)
    else:
        _from_authorization_token = _speech_py_impl.CustomCommandsConfig__from_authorization_token
...
def CustomCommandsConfig__from_subscription(appId , subscription , region )  :
    return _speech_py_impl.CustomCommandsConfig__from_subscription(appId, subscription, region)
CustomCommandsConfig__from_subscription = _speech_py_impl.CustomCommandsConfig__from_subscription

def CustomCommandsConfig__from_authorization_token(appId , authToken , region )  :
    return _speech_py_impl.CustomCommandsConfig__from_authorization_token(appId, authToken, region)
CustomCommandsConfig__from_authorization_token = _speech_py_impl.CustomCommandsConfig__from_authorization_token
...
class Conversation(_object):
    ...
    def _get_conversation_id(self)  :
        return _speech_py_impl.Conversation__get_conversation_id(self)
...
class ActivityReceivedEventArgs(_object):
    ...
    def _get_activity(self)  :
        return _speech_py_impl.ActivityReceivedEventArgs__get_activity(self)

    def _get_audio(self)  :
        return _speech_py_impl.ActivityReceivedEventArgs__get_audio(self)

    def has_audio(self)  :
        return _speech_py_impl.ActivityReceivedEventArgs_has_audio(self)

    __swig_getmethods__["has_audio"] = _speech_py_impl.ActivityReceivedEventArgs_has_audio
    if _newclass: has_audio = property(_speech_py_impl.ActivityReceivedEventArgs_has_audio)
    ...
    def audio(self)  :
        """
        Audio associated with the event.
        """
...
class TurnStatusReceivedEventArgs(_object):
    ...
    def _get_interaction_id(self)  :
        return _speech_py_impl.TurnStatusReceivedEventArgs__get_interaction_id(self)

    def _get_conversation_id(self)  :
        return _speech_py_impl.TurnStatusReceivedEventArgs__get_conversation_id(self)

    def _get_status_code(self)  :
        return _speech_py_impl.TurnStatusReceivedEventArgs__get_status_code(self)

    @property
    def interaction_id(self)  :
        """
        Interaction ID associated with turn status event.
        """
        return self._get_interaction_id()


    @property
    def conversation_id(self)  :
        """
        Conversation ID associated with turn status event.
        """
    ...
    def status_code(self)  :
        """
        Numeric status code associated with this turn status event.
        """
...
class ActivityReceivedEventSignal(_object):
    ...
    def connect(self, func , wrapped_type )  :
        ...
        """
        return _speech_py_impl.ActivityReceivedEventSignal_connect(self, func, wrapped_type)
...
class TurnStatusReceivedEventSignal(_object):
    ...
    def connect(self, func , wrapped_type )  :
        ...
        """
        return _speech_py_impl.TurnStatusReceivedEventSignal_connect(self, func, wrapped_type)
...
class DialogServiceConnector(_object):
    ...
    __del__ = lambda self: None
    if _newclass:
        _from_config = staticmethod(_speech_py_impl.DialogServiceConnector__from_config)
    else:
        _from_config = _speech_py_impl.DialogServiceConnector__from_config
    ...
    __swig_getmethods__["speech_start_detected"] = _speech_py_impl.DialogServiceConnector_speech_start_detected_get
    if _newclass:
        speech_start_detected = _swig_property(_speech_py_impl.DialogServiceConnector_speech_start_detected_get)
    __swig_getmethods__["speech_end_detected"] = _speech_py_impl.DialogServiceConnector_speech_end_detected_get
    if _newclass:
        speech_end_detected = _swig_property(_speech_py_impl.DialogServiceConnector_speech_end_detected_get)
...
def DialogServiceConnector__from_config(connectorConfig , audioConfig =0)  :
    return _speech_py_impl.DialogServiceConnector__from_config(connectorConfig, audioConfig)
DialogServiceConnector__from_config = _speech_py_impl.DialogServiceConnector__from_config
...
class PronunciationAssessmentConfig(_object):
    ...
    def set_phoneme_alphabet(self, phonemeAlphabet )  :
        return _speech_py_impl.PronunciationAssessmentConfig_set_phoneme_alphabet(self, phonemeAlphabet)

    def set_nbest_phoneme_count(self, count )  :
        return _speech_py_impl.PronunciationAssessmentConfig_set_nbest_phoneme_count(self, count)
